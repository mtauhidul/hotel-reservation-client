...
const EditRoomForm = ({ data, getData }: EditRoomFormProps) => {
  ...
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const roomUpdatePromise = updateRoom(room.id, room);
  ...
  useEffect(() => {
    ...
    setPriceEN(data.priceEN);
    setBreakfastEN(data.breakfastEN);
    setCapacityEN(data.capacityEN);
    setBathtubEN(data.bathtubEN);
    setTypeEN(data.typeEN);
    setPetsEN(data.petsEN);
    setImagesEN(data.imagesEN);
    setThumbnailEN(data.thumbnailEN);
